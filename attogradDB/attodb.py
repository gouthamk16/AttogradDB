...
class VectorStore:
    ...
    ## Don't know if this implementation is correct. Auto generated by Cursor.
    ## Write tests for this function. 
    def load_index(self):
        '''
        Load the vector index from a file.
        If save_path is not specified, load the index from a file named "stored_indices.json" in the current working directory.
        '''
        if self.save_path:
            with open(self.save_path, "r") as f:
                self.vector = json.load(f)
        else:
            with open("stored_indices.json", "r") as f:
                self.vector = json.load(f)
